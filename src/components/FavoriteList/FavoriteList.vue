    ...
    <div class="favorite-list">
        ...
        <div class="toolbar">
            <div class="left">
                <el-button-group class="action-group">
                    <el-button type="primary" :disabled="!selectedItems.length" @click="handleBatchMove"
                        class="batch-button">
                        <el-icon>
                            <FolderAdd />
                        </el-icon>
        ...
        <div class="list-content" v-loading="loading">
            <div class="grid-view" :class="{ 'is-empty': !processedFavorites.length }">
                <TransitionGroup name="grid-fade" tag="div" class="grid-container">
            ...
            <div v-if="!loading && !processedFavorites.length" class="empty-state">
                <el-empty :image="emptyImage" :image-size="200" description="暂无收藏内容">
        ...
        <div class="pagination-wrapper" v-if="processedFavorites.length">
            <el-pagination :current-page="currentPage" :page-size="pageSize" :page-sizes="[12, 24, 36, 48]"
                :total="total" layout="total, sizes, prev, pager, next, jumper" @update:current-page="handlePageChange"
                @update:page-size="handleSizeChange" background />
        </div>

        <!-- 移动分类对话框 -->
        <el-dialog v-model="moveDialogVisible" title="移动到分类" width="30%" :close-on-click-modal="false">
            <el-form>
        ...
        <!-- 修改删除确认对话框 -->
        <el-dialog v-model="deleteDialogVisible" :title="dialogTitle" width="400px">
