            ...
            <div class="dialog-container" @click.stop>
                ...
                <div class="detail-content">
                    <div class="image-container">
                        <el-image :src="destination?.imageUrl" :alt="destination?.name + ' 景区图片'" class="detail-image"
                            fit="cover">
                    ...
                    <div class="detail-info-section">
                        ...
                        <div class="detail-tags">
                            <span v-for="(tag, index) in destination?.tags" :key="index" class="tag"
                                @click="handleTagClick(tag)" :class="{ 'tag-clicked': clickedTags[index] }">
                        ...
                        <div class="best-seasons">
                            ...
                            <div class="seasons-list">
                                <template v-if="destination?.bestSeasons?.length">
                                    <span v-for="(season, index) in destination.bestSeasons" :key="index"
                        ...
                        <div v-if="destination?.seasonalFeatures" class="seasonal-features">
                            ...
                            <div class="features-list">
                                <div v-for="(feature, season) in destination.seasonalFeatures" :key="season"
                                    class="feature-item">
                    ...
                    <div v-if="similarDestinations.length" class="similar-destinations">
                        ...
                        <div class="similar-container">
                            <div class="similar-grid" ref="scrollContainer" @mousedown="startDrag" @mousemove="onDrag"
                                @mouseup="stopDrag" @mouseleave="stopDrag" @scroll="handleScroll">
                                <div v-for="dest in similarDestinations" :key="dest.id" class="similar-item"
                                    @click="handleSimilarClick(dest)">
                                    <div class="image-container">
                                        <img :src="dest.imageUrl" :alt="dest.name + ' 缩略图'" class="similar-image"
