...
//获取基于协同过滤的推荐目的地
export const getCollaborativeFilteringRecommendationsAPI = () => {
    return request({
        url: '/dev-api/recommend/collaborative',
        method: 'GET',
        needToken: true
    })
}
...
//获取相似用户的推荐目的地
export const getSimilarUsersRecommendationsAPI = () => {
    return request({
        url: '/dev-api/recommend/similar-users',
        method: 'GET',
        needToken: true
    })
}